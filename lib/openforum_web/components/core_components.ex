defmodule OpenforumWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OpenforumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OpenforumWeb.Gettext, "errors", msg, opts)
    end
  end
