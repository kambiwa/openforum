# defmodule OpenforumWeb.Auth.Admin.Departments do
...
#   alias EnrouteHaye.Schema.Department
...
#     |> assign(:department, CxtDepartment.get_department!(id))
#   end
...
#     |> fetch_filtered_department()
#   end

#   @impl true
#   def handle_info(
#         {OpenforumWeb.Departments.FormComponent, {:saved, _department}},
#         socket
#       ) do
#     {:noreply, fetch_filtered_department(socket)}
#   end

#   @impl true
#   def handle_event("add_department", _params, socket) do
#     {:noreply,
#      socket
#      |> assign(:page_title, "New Department")
#      |> assign(:department, %Department{})
...
#   defp fetch_filtered_department(socket) do
#     filters = %{
...
#     ~H"""
#     <Layouts.admin_app flash={@flash} current_scope={@current_scope} current_page={:department}>
...
#               Manage department listings and their details.
#             </p>
#           </div>
...
#             >
#               <.icon name="hero-plus" class="size-4" /> New Department
#             </button>
#           </div>
#         </div>
...
#             <h2 style="font-size: 0.85rem; font-weight: 600; color: #374151;">All Departments</h2>
#           </div>

#           <Table.table id="tbl_department" rows={@data}>
#             <:col :let={department} label="Name">
#               <span style="color: #374151; font-weight: 500;">{department.name}</span>
#             </:col>
#             <:col :let={department} label="Status">
#               <span style="color: #6b7280;">{department.status}</span>
#             </:col>
...
#           <.modal
#             id={"crud-department-modal-#{(@department && @department.id) || :new}"}
#             show
#             on_cancel={JS.push("close")}
#           >
#             <.live_component
#               module={OpenforumWeb.Departments.FormComponent}
#               id={(@department && @department.id) || :new}
#               title={@page_title}
#               action={@live_action}
#               department={@department}
#               patch={~p"/admin/department"}
#             />
#           </.modal>
#         <% end %>
