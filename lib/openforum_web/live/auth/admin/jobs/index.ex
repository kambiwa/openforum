# defmodule OpenforumWeb.Auth.Admin.Jobs do
...
#   @impl true
#   def handle_info(
#         {OpenforumWeb.Jobs.FormComponent, {:saved, _job}},
#         socket
#       ) do
#     {:noreply, fetch_filtered_job(socket)}
#   end
...
#   defp fetch_filtered_job(socket) do
#     filters = %{
...
#     ~H"""
#     <Layouts.admin_app flash={@flash} current_scope={@current_scope} current_page={:job}>
...
#               Manage job listings and their details.
#             </p>
#           </div>
...
#               <span style="color: #374151; font-weight: 500;">{job.name}</span>
#             </:col>
#             <:col :let={job} label="Status">
#               <span style="color: #6b7280;">{job.status}</span>
#             </:col>
...
#           <.modal
#             id={"crud-job-modal-#{(@job && @job.id) || :new}"}
#             show
#             on_cancel={JS.push("close")}
#           >
#             <.live_component
#               module={OpenforumWeb.Jobs.FormComponent}
#               id={(@job && @job.id) || :new}
#               title={@page_title}
#               action={@live_action}
#               job={@job}
