defmodule OpenforumWeb.Router do
  use OpenforumWeb, :router

  import OpenforumWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {OpenforumWeb.Layouts, :root}
  ...
  if Application.compile_env(:openforum, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: OpenforumWeb.Telemetry
